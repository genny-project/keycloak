#!/bin/bash
./add-customer.sh http://localhost:8080 ${KEYCLOAK_PASSWORD} genny  localhost:8080  056b73c1-7078-411d-80ec-87d41c55c3b4 Alyson Genny  password1 genny@genny.live genny+admin@genny.live
