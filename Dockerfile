...
USER jboss
#https://downloads.jboss.org/keycloak/5.0.0/keycloak-5.0.0.tar.gz
...
RUN java -jar /usr/share/java/saxon.jar -s:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml -xsl:/opt/jboss/keycloak/setLogLevel.xsl -o:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml
...
#RUN java -jar /usr/share/java/saxon.jar -s:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml -xsl:/opt/jboss/keycloak/addHttps.xsl realmName=$REALM_NAME secret=$SECRET -o:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml
...
#RUN java -jar /usr/share/java/saxon.jar -s:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml -xsl:/opt/jboss/keycloak/addTruststore.xsl realmName=$REALM_NAME secret=$SECRET -o:/opt/jboss/keycloak/standalone/configuration/standalone-ha.xml
